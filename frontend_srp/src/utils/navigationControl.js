...
class NavigationControl {
    ...
    enable() {
        ...
        this.isEnabled = true;
        console.log('🚫 Navegación del navegador deshabilitada. Usa breadcrumbs para navegar.');
    }
...
export const allowNavigation = (callback) => navigationControl.allowNavigation(callback);