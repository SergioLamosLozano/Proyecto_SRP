...
export const estudiantesAPI = {
  ...
  downloadTemplate: () => api.get('/estudiantes/template/', { responseType: 'blob' }),
...
export const profesoresAPI = {
  ...
  // Descargar plantilla Excel
  downloadTemplate: () => api.get('/profesores/template/', { responseType: 'blob' }),
  // Carga masiva via Excel
  bulkUpload: (file) => {
    const formData = new FormData();
    formData.append('file', file);
...
export const acudientesAPI = {
  getAll: () => api.get('/acudiente/'),
  getById: (id) => api.get(`/acudiente/${id}/`),
  create: (data) => api.post('/acudiente/', data),
  update: (id, data) => api.put(`/acudiente/${id}/`, data),
  delete: (id) => api.delete(`/acudiente/${id}/`)
};
...
export const estudiantesAcudientesAPI = {
  ...
  por_estudiante: (estudiante_id) => api.get(`/estudiantes-acudientes/por_estudiante/?estudiante_id=${estudiante_id}`),
  por_acudiente: (acudiente_id) => api.get(`/estudiantes-acudientes/por_acudiente/?acudiente_id=${acudiente_id}`)
};